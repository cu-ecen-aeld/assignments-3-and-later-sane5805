...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    echo "Cleaning the kernel built tree"
    make ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE} mrproper

    echo "Generating a default kernel configuration"
    ...
    echo "Generating Device Tree Binary files"
...
echo "Setting up necessary Base directories"
mkdir ${OUTDIR}/rootfs
cd ${OUTDIR}/rootfs
...
echo "Clean & Build the writer utility"
...
echo "finder related scripts and executables copy done"
